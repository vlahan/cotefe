...
urlpatterns = patterns('',
    ...
    url(r'^experiments/(?P<experiment_id>\w+)/virtual-nodegroups/(?P<virtual_nodegroup_id>\w+)/image/(?P<image_id>\w+)$', burn_image_to_virtual_nodegroup_handler),
    url(r'^experiments/(?P<experiment_id>\w+)/virtual-nodegroups/(?P<virtual_nodegroup_id>\w+)/image$', erase_image_to_virtual_nodegroup_handler),
    ...
    url(r'^jobs/(?P<job_id>\w+)/tasks/(?P<task_id>\w+)/run$', run_task_resource_handler),
